    ...
    <div className="flex items-center gap-0.5 rounded-md border border-paper-200" role="group" aria-label="字号选择">
      {OPTIONS.map(({ key, label }) => (
        <button
          ...
          className={cn(
            "px-3 py-1 text-xs transition-colors first:rounded-l-md last:rounded-r-md focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-glow",
            value === key
